...
const unsigned int &Film::getID() const
{
    return id;
}
...
const unsigned int &Film::getYear() const
{
    return prod_year;
}

const std::map<std::string, std::string> &Film::getCast() const
{
    return cast;
}
const std::string &Film::getDir() const
{
    return director;
}
...
const std::string &Film::getDesc() const
{
    return desc;
}
const unsigned int &Film::getTime() const
{
    return time;
}

const std::vector<film_genre> &Film::getGenre() const
{
    return genre;
}
...
{
    if (genreStr == "Action")
        return film_genre::Action;
    if (genreStr == "Adventure")
        return film_genre::Adventure;
    if (genreStr == "Comedy")
        return film_genre::Comedy;
    if (genreStr == "Drama")
        return film_genre::Drama;
    if (genreStr == "Fantasy")
        return film_genre::Fantasy;
    if (genreStr == "Horror")
        return film_genre::Horror;
    if (genreStr == "Mystery")
        return film_genre::Mystery;
    if (genreStr == "Romance")
        return film_genre::Romance;
    if (genreStr == "Science Fiction")
        return film_genre::SciFi;
    if (genreStr == "Thriller")
        return film_genre::Thriller;
    if (genreStr == "Western")
        return film_genre::Western;
