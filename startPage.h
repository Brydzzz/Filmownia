...
class StartPage : public Page {
    ...
    std::vector<std::string> optionsRest = {"Browse", "Exit", "MyPage",
                                            "LogOut"};
    std::vector<std::string> optionsGuest = {"Browse", "Exit", "SignUp",
                                             "LogIn"};
    std::string msg =
        "Welcome to Filmownia movie database!\nPresented to you by: Brygida S, "
        "Kinga Ł and Tomasz S";
